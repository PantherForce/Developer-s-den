  ...
  return (
    <div className="text-white">
      <div className=" flex justify-center  mt-[-96px] mx-auto items-center flex-col h-screen w-[100%]">
        ...
        <span className="flex flex-row gap-10 py-5 px-5">
          <button className="bg-[#00df9a] text-[#000] font-bold 400 w-[100px] rounded-md my-6 mx-auto py-2 px-3">
            Login{" "}
          </button>
          <button className="bg-[#00df9a]  text-[#000] font-bold 400  w-[100px] rounded-md my-6 mx-auto py-2 px-3">
            Sign up{" "}
